...
class TruckController extends Controller {
    ...
    public function index() {
        return view('dashboard/truck/truckList');
    }
    ...
    public function saveTruck(Request $request, $cId = null) {
        ...
        if ($request->isMethod('get')) {
            $DealerVehicle = DealerVehicle::select('dealer_vehicles.id','v.vehicle_name')
                    ->leftJoin('vehicles as v','v.id','dealer_vehicles.vehicle_id')
                    ->where(['dealer_id' => $userId])
                    ->get();
            $TruckDetails = "";
            $button = 'Add';
            ...
            return view('dashboard.truck.addTruck', ['DealerVehicle'=>$DealerVehicle,'TruckDetails' => $TruckDetails, 'button' => $button, 'vehicleType' => $vehicleType]);
        }
        /* ADD/EDIT COMPANY */
...
//            prd($postData);
            ...
            $TruckDetails->dealer_id = !empty($userId) ? $userId : $TruckDetails->dealer_id;
            $TruckDetails->dealervehicle_id = !empty($postData['dealervehicle_id']) ? $postData['dealervehicle_id'] : $TruckDetails->dealervehicle_id;
