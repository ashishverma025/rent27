            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-sm-6"> 
                    <div class="footer-col footer-logo">
                        <img src="{{asset('assets/sites/images/logo.png')}}" width="220" height="100" alt="footer">
                        <p>
        ...
        <div id="cd-signup"> <!-- sign up form -->
            ...
            <form class="cd-form" id="signUpForm" action="{{url('register')}}" method="post">
                ...
                <p class="fieldset">
                    ...
                    <span class="cd-error-message role_id_err">Error message here!</span>
                </p>
               ...
               <select class="full-width has-padding has-border form-control" id="signupUserType">
                ...
                <span class=" password_confirmation_err"></span>
...
<!--                    <input type="submit" class="full-width has-padding" id="signupBtn" value="Create account">-->
            ...
            <script type="text/javascript">
                $("#signUpForm").on('submit', function(e){
                    $(".role_id_err,.email_err,.fname_err,.lname_err,.password_err,.password_confirmation_err").text('');
                        ...
                        success: function (data) {
                            if(data.errors)
                            {
                                $.each(data.errors, function(key, value) {
                                    ...
                                    if(key == 'password'){
                                        $("."+key+"_err").text('Password must have at least 1 special char, number,uppercase and lowecase letter.');
                                    }else{
