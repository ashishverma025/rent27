                ...
                <div class="card-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="btn-group">
                                    <a href="{{url('admin/addBlog')}}" id="update_attendance_table" class=" btn btn-primary"> Add New</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table  table-striped table-bordered table-hover dataTable no-footer" data-page-length='10' id="editable_table" role="grid">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Blog Image</th>
                                            <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Blog Title</th>
                                            <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Blog Url</th>
                                            <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Description</th>
                                            <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Blog Rating</th>
...
//Bootstrap Duallistbox
    ...
    $(document).ready(function () {
        ...
        if (user_type == '') {
            var url = base_url + '/fetchBlog'
        } else {
            var url = base_url + '/fetchBlog/' + user_type
        }
        console.log(url);
