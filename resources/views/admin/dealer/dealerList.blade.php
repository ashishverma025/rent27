                ...
                <div class="card-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="btn-group">
                                    <a href="{{url('admin/addDealer')}}" id="update_attendance_table" class=" btn btn-primary"> Add New</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
//Bootstrap Duallistbox
    ...
    $(document).ready(function () {
        ...
        if (user_type == '') {
            var url = base_url + '/fetchDealer'
        } else {
            var url = base_url + '/fetchDealer/' + user_type
        }
        console.log(url);
