                ...
                <div class="card-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="btn-group">
                                    <a href="{{url('addDealerVehicle')}}" id="update_attendance_table" class=" btn btn-primary"> Add Truck For Rental</a>
                                </div>
                            </div>

                            <div class="col-md-2">
                                <div class="btn-group">
                                    <a href="{{url('addDealerVehicleSell')}}" id="update_attendance_table" class=" btn btn-primary"> Add Truck For Sale</a>
                                </div>
                            </div>
                        </div>
                    </div>
