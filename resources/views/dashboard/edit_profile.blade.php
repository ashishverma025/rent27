@extends('dashboard.layout.profile')
@section('content')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">          
                                                    <div class="input-group">
                                                        ...
                                                        <input id="phone" type="text" class="form-control" value="{{ ($userDetails->mobile_no != '') ? $userDetails->mobile_no : ''}}" name="phone" placeholder="Verified ">
                                                    </div>
                                                </div>
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <div class="checkbox">
