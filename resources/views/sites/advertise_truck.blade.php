...
<section id="truck-detail">
    <div class="container all-head">
      <span> <h1> Advertise Your Truck</h1></span>
    </div>

</section>
<div class="advertise_truck">
<div class="col-md-6 col-sm-6 truck-for-sale">
    <a style="width: 250px" href="{{ url('/addDealerVehicleSell') }}">Advertise Your Truck for Sale</a>
<div class="truck_img"><img src="{{URL::asset('/assets/sites/images/truck-img1.jpg')}}" /></div>
</div>
<div class="col-md-6 col-sm-6 truck-for-rent">
    <a style="width: 250px" href="{{ url('/addDealerVehicle') }}">Advertise Your Truck for Rental</a>
<div class="truck_img"><img src="{{URL::asset('/assets/sites/images/truck-img2.jpg')}}" /></div>
</div>
</div>
    ...
    <div class="container">
        ...
        <div class="cal-list">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="exp-btn"><button >BUy NOW</button></div>
                </div>
            </div>
        </div>
        @endforeach
