...
The use of this website is subject to the following terms of use:
			   ...
			   <div class="card">
                  ...
                  <div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#accordion">
                     <div class="card-body">
                       All trade marks reproduced in this website which are not the property of, or licensed to, the operator are acknowledged on the website.</div>
                  </div>
               </div>
			   <!-- -->
			   <!-- -->
			   ...
			   <div class="card">
                  ...
                  <div id="collapse10" class="collapse" aria-labelledby="heading10" data-parent="#accordion">
                     <div class="card-body">
                        Cancellation: If at any point you would like to cancel your membership, you should send us an email fifteen day before the due date. Failure to do so would let your account start your monthly cycle.
						</div>
                  </div>
               </div>
			   <!-- -->
			   ...
			   <div class="card">
                  ...
                  <div id="collapse11" class="collapse" aria-labelledby="heading11" data-parent="#accordion">
                     <div class="card-body">
                       Emptytruck100.com is designed to work similar like a dating site. We are the bridge between the customers, drivers and companies. Therefore, we are not responsible for what transpired between drivers, companies and customers. So, if goods are damage, lost or stolen or any other incident that happen the drivers, customers or companies would need to work together and solve any problem that occur.
					   </div>
                  </div>
               </div>
			   <!-- -->
			   ...
			   <div class="card">
                  ...
                  <div id="collapse13" class="collapse" aria-labelledby="heading13" data-parent="#accordion">
                     <div class="card-body">
                      Our advice to all our customers please to use verified drivers and companies.
					  </div>
                  </div>
               </div>
			   <!-- -->
			   ...
			   <div class="card">
                  ...
                  <div id="collapse14" class="collapse" aria-labelledby="heading14" data-parent="#accordion">
                     <div class="card-body">
                      Termination: We may terminate or suspend access to our service without prior notice or liability for any reason whatsoever, including without limitation. If you breach the Terms. The number of trucks you pay to advertise on our site, that is the number of trucks you are allow to use on our site. So please to abide by our guide line and avoid termination
					  </div>
                  </div>
               </div>
			   <!-- -->
