...
<section id="business-sec">
    <div class="container">
        <div class="all-head">
            ...
            <h2> Sale subscription packages.  <span> </span> </h2>
        </div>
		<div class="package-section">
            <div class="package-col gold-package">
                <ul>
                    <li><h3><?php echo $plans[0]->name; ?></h3></li>
                    <li class="package-price"><span>$</span><?php echo $plans[0]->price; ?></li>
                    <!-- <li>Description <?php echo $plans[0]->description; ?> </li> -->
                    <!-- <li>PricePer<?php echo $plans[0]->price_per; ?></li> -->
                    <li>For 28 days</li>
                    <li>You Save <?php echo $plans[0]->discount; ?></li>
                    <!-- <li>engagements <?php echo $plans[0]->engagements; ?></li> -->
                    <div id="paypal-button"></div>
                    <input id="paymentInput" type="hidden" value="<?php echo $plans[0]->price; ?>"/>
                </ul>
            </div>
        </div>
