                                    ...
                                    <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                        <tr>
                                            ...
                                            <p style="font-weight: 800; margin-bottom: 30px;">
                                                ...
                                                <a href="{{$data['url']}}" style="display: inline-block; padding: 12px 30px; color: #fff; background: #011f3f; border-radius: 4px; text-decoration: none; margin: 5px 10px 5px 0">EmptyTruck100</a>
