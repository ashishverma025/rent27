...
Route::get('/listing/truck', 'WelcomeController@listingTruck');
...
Route::get('/truck-for-sale', 'WelcomeController@truckForSale');
Route::get('/truck-for-rental', 'WelcomeController@truckForRental');
